...
<title>Volunteer View - Rescue Cases | RescueNet</title>
<link
...
<body>
	<div class="container-fluid mt-4">
		<div class="card admin-table">
			<div class="card-header">
				<h3>
					<i class="bi bi-clipboard2-pulse"></i> All Rescue Cases
				</h3>
			</div>
			<div class="card-body">
    ...
    %> <span class="<%= badgeClass %>"><%= status %></span>
							...
							<td>
								<%
        if (!"Rescue Completed".equalsIgnoreCase(status)) {
    %>
								<form action="updateStatus" method="post" class="d-inline">
									<input type="hidden" name="caseId" value="<%= re.getrId() %>">
									<input type="hidden" name="newStatus" value="Rescue Completed">
									<button type="submit" class="btn btn-sm btn-success">Mark
										as Completed</button>
								</form> <%
        } else {
    ...
    %>
                    ...
                    <a href=volunteerViewCases class="back-btn">
